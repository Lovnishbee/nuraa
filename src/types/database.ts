...
export type Database = {
  public: {
    Tables: {
      ...
      daily_checkins: { Row: { id: string; user_id: string; checkin_date: string; mood: string | null; energy_level: number | null; stress_level: number | null; sleep_quality: number | null; sleep_hours: number | null; notes: string | null; created_at: string }; Insert: Record<string, unknown>; Update: Record<string, unknown> }
