...
export function NuraaScoreCard({ score = 0, category = 'Setting up your readiness baseline', reason, note, hasBaseline = false, status, onRetry }: StatefulWidgetProps & { score?: number | null; category?: string | null; reason?: string | null; note?: string | null; hasBaseline?: boolean }) {
  return (
