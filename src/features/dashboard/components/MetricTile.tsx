...
export function MetricTile({ label, value, detail, icon: Icon, tone = 'nuraa' }: { label: string; value: string; detail?: string; icon: LucideIcon; tone?: 'nuraa' | 'blue' | 'amber' | 'violet' }) {
  return (
    <div className={cn('rounded-3xl border border-forest/10 bg-white p-4 shadow-sm transition hover:-translate-y-0.5 hover:shadow-[0_16px_34px_rgba(22,52,47,.08)]')}>
